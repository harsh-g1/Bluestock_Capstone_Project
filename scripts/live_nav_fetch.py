...
df.to_csv(RAW_DIR / "live_nav_hdfc_top_100_direct.csv", index=False)
...
sbi_df.to_csv(RAW_DIR / "live_nav_sbi_bluechip.csv", index=False)
...
icici_df.to_csv(RAW_DIR / "live_nav_icici_bluechip.csv", index=False)
...
nippon_df.to_csv(RAW_DIR / "live_nav_nippon_large_cap.csv", index=False)
...
axis_df.to_csv(RAW_DIR / "live_nav_axis_bluechip.csv", index=False)
...
kotak_df.to_csv(RAW_DIR / "live_nav_kotak_bluechip.csv", index=False)